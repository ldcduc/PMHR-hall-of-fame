        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 max-w-md">
              Celebrating our elite runners and their achievements. Join our
              community of passionate runners pushing the limits of human
              endurance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://zalo.me/g/ipgfme834"
                  className="text-gray-300 hover:text-white transition-colors duration-150 flex items-center"
                >
                  <svg
                    width="16"
                    height="16"
              ...
              <li>
                <a
                  href="https://www.facebook.com/phumyhungrunners"
                  className="text-gray-300 hover:text-white transition-colors duration-150 flex items-center"
                >
                  <svg
