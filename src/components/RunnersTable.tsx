...
import {
  ...
  safeTimeCompare,
  safeStringCompare,
  safeAchievementCompare,
  SortDirection,
} from "../utils/safeCompare";
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10">
                        <Image
                          ...
                          src={
                            runner.profileImage ||
                            `https://ui-avatars.com/api/?name=${encodeURIComponent(runner.name)}&background=3b82f6&color=fff`
                          }
                          width={40}
                          height={40}
                          alt={runner.name}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`font-mono text-sm font-medium ${
                        runner.halfMarathonPR && runner.halfMarathonPR !== "N/A"
                          ? "text-blue-600"
                          : "text-gray-400"
                      }`}
                    >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`font-mono text-sm font-medium ${
                        runner.fullMarathonPR && runner.fullMarathonPR !== "N/A"
                          ? "text-red-600"
                          : "text-gray-400"
                      }`}
                    >
